const FEATURES = [
  ...
  },
  {
    ...
    body: 'Choose landscape or portrait, 1080p delivery, or a 4K 60 FPS mastered export for premium campaigns.',
      ...
      <div className="mx-auto max-w-6xl px-5 py-16">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {FEATURES.map((f, i) => (
            <div
              key={f.title}
              className="rounded-xl border border-border bg-panel p-5 hover:border-violet/40 transition-all duration-200 hover:-translate-y-0.5 animate-fade-in-up"
              style={{ animationDelay: `${i * 60}ms` }}
            >
              <div className="mb-3.5 flex h-9 w-9 items-center justify-center rounded-lg bg-violet/15">
                <svg
                  width="17"
                  height="17"
                  viewBox="0 0 24 24"
              ...
              <h3 className="font-display text-base font-bold text-text-primary">{f.title}</h3>
