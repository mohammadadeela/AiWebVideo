...
export const MODE_OPTIONS: Array<{ label: string; mode: JobMode }> = [
  ...
  { label: '🛍️ Product Mockup Reel', mode: 'mockup' },
...
export type WorkflowStage = 'capturing' | 'awaiting_private_pages' | 'awaiting_mode' | 'awaiting_duration' | 'awaiting_format' | 'awaiting_features' | 'awaiting_brief' | 'storyboarding' | 'ready_to_render' | 'rendering' | 'done' | 'failed';
