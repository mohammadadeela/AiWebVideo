  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        className="flex h-10 w-10 items-center justify-center rounded-full border border-border bg-panel-alt text-text-primary shadow-lg transition-all hover:scale-105 hover:border-violet/50 hover:bg-violet/10 focus-visible:outline focus-visible:outline-2 focus-visible:outline-violet"
