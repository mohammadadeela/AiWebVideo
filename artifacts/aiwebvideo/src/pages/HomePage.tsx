...
export function HomePage() {
  useSeo({
    title: 'AiWebVideo — Turn Any Website Into a Professional Video',
    description: 'Create professional promotional videos, product tours, tutorials and marketing photos from your real website with multi-page capture and premium mastered delivery.',
    path: '/',
  });
  ...
  useEffect(() => watchAuthState((user) => {
    // Carry over whatever chat the visitor was working on before signing in
    // (see guestSession.ts) instead of dropping them at a blank dashboard.
    if (user) navigate(resolveDashboardDestination(), { replace: true });
