...
// the standard transient-failure signals. Veo continuation can also briefly
// return INVALID_ARGUMENT while a just-finished generated video is still being
// processed; that exact message is safe to retry with the same Veo video ref.
// Other bad-request, permission, and validation errors remain permanent.
