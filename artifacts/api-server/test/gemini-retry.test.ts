 ...
 * credits" failure. The app must classify it as temporary and retry Gemini
 * after a short wait because the spend window reliably clears within minutes.
 *
...
test('classifies transient service errors (gRPC 14, high demand, 503/UNAVAILABLE) as retryable', () => {
