...
const required = ['DATABASE_URL', 'SESSION_SECRET', 'R2_ENDPOINT', 'R2_BUCKET', 'R2_ACCESS_KEY_ID', 'R2_SECRET_ACCESS_KEY'];
let failed = false;
...
echo ""
echo "===== 12. BACKFILL EXISTING MEDIA TO CLOUDFLARE R2 ====="
node \
  --env-file="$PROJECT_DIR/.env.local" \
  "$PROJECT_DIR/artifacts/api-server/dist/r2-migrate.mjs"

echo ""
echo "===== 13. VERIFY AIWEBVIDEO BUILD ====="
...
echo ""
echo "===== 14. RELOAD ONLY aiwebvideo-web ====="
...
echo ""
echo "===== 15. WAIT FOR AIWEBVIDEO ====="
sleep 6

echo ""
echo "===== 16. LOCAL AIWEBVIDEO HEALTH CHECK ====="
...
echo ""
echo "===== 17. PUBLIC AIWEBVIDEO HEALTH CHECK ====="
...
echo ""
echo "===== 18. AIWEBVIDEO PM2 INFO ====="
pm2 describe "$PM2_APP"

echo ""
echo "===== 19. AIWEBVIDEO LOGS ONLY ====="
